...
class Triangle extends Geometry {
  ...
  constructor(size, centerX, centerY) {
    ...
    this.indices = this.generateTriangleIndices();
  }
  ...
  generateTriangleVertices(size, centerX, centerY) {
    ...
    var vertices = [new Vertex(top_x, top_y, 0.0),
                    new Vertex(left_x, left_y, 0.0),
                    new Vertex(right_x, right_y, 0.0)];

    return vertices;
  }
  /**
   * Generates the indices of the Triangle.
   *
   * @private
   */
